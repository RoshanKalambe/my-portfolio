...
// Make hero section visible immediately on home page
...
if (contactForm) {
    contactForm.addEventListener('submit', function(e) {
        ...
        // Create mailto link
        const mailtoLink = `mailto:rshnklmb@gmail.com?subject=${encodeURIComponent(subject)}&body=${encodeURIComponent(
            `Name: ${name}\nEmail: ${email}\n\nMessage:\n${message}`
        )}`;
...
// Add hover effect to overview cards
...
if (profileImage) {
    ...
    profileImage.onerror = function() {
        ...
        this.src = 'https://via.placeholder.com/320x320?text=Profile+Photo';
    };
}
